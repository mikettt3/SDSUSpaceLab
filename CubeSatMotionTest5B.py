...
try:
    while i<=(runtime-1):
        ...
        # Minimize yawSum/ yawErr
        if (abs(yawErr*K))>=dy: 
            # Then correct attitude, Send err amount, dir to drive rxn wheels or mtqs
            DriveWheels(yawErr*K)
        elif (abs(yawErr*K))<dy: 
