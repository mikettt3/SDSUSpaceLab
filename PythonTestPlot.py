...
# plot yawGyro0 from CUbeSatMotionTest2A.py. This will show the output for the gyroscope. Check that it is not relatively large while the CubeSat is not moving.
